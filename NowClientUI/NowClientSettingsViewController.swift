//
//  NowClientSettingsViewController.swift
//  Loop
//
...
public class NowClientSettingsViewController: UITableViewController {
    ...
    public let cgmManager: NowClientManager
    ...
    public init(cgmManager: NowClientManager, displayGlucosePreference: DisplayGlucosePreference, allowsDeletion: Bool) {
    ...
    public override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .authentication:
            ...
            let service = cgmManager.nowService
    ...
    public override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        switch Section(rawValue: indexPath.section)! {
        case .authentication:
            let vc = AuthenticationViewController(authentication: cgmManager.nowService)
